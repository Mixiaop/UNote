define(['jquery', 'utils/notify', 'bootstrap'], function ($, notify) {
    ...
    var $parentName, $parentId, $name, $icon, $des, $order, $public, $types, $customUrl;
    var vm = {
        committing: false,
        form: {},
        options: {
    ...
    function _initialize() {
        ...
        $customUrl = $container.find('#txtCustomUrl');
        ...
        $container.find('.btn-primary').on('click', function () {
            ...
            vm.form.customUrl = $customUrl.val();
            ...
            input.CustomUrl = vm.form.customUrl;
