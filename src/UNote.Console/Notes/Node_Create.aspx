<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/UZero.Master" AutoEventWireup="true" CodeBehind="Node_Create.aspx.cs" Inherits="UNote.Console.Notes.Node_Create" %>
    ...
    <form runat="server">
        ...
        <div class="content bg-gray-lighter">
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">添加新分类<small></small>
                    </h1>
                </div>
            ...
            <div class="block">
                <div class="block-content block-content-narrow">
                    ...
                    <div class="form-horizontal push-10-t">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <asp:Button runat="server" ID="btnSave" CssClass="btn btn-primary"  Text="添加新分类"   />
                            </div>
                        </div>
                    </div>
                </div>
