...
namespace UNote.Console.Notes.UI
{
    public class NodePage : Infrastructure.UNotePage
    {
        ...
        public void LoadNodeListItemToDLL(DropDownList ddl, IList<Node> allNodes)
        {
            ...
            {
                ddl.Items.Add(new ListItem(node.NodeName, node.Id.ToString()));
        ...
        void AddNoteListItem(DropDownList ddl, IList<Node> allNodes, Node currentNode)
        {
            ...
            childNodes.ForEach((node) =>
            {
                ...
                ddl.Items.Add(new ListItem(blank + node.NodeName, node.Id.ToString()));
                AddNoteListItem(ddl, allNodes, node);
            });
        }
    }
